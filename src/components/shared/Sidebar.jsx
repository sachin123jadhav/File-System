...
<button  onClick={Logout}>  <PowerIcon className="h-5 w-5 text-rose-700" /></button>
     ...
     <img className="mobile-logo" src={imgmeta} alt="MetaMind" style={{maxWidth:"200px"}}  />
      <div onClick={() => setNav(!nav)}
        ...
        {nav && (
          <ul className="flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-gray-800 text-gray-500 z-0" style={{zIndex:"9"}}>
